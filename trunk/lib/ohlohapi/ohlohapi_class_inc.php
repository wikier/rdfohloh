...
class ohlohapi 
{
	...
	/**
	 * Get Project contributors for a specific project by its Project ID
	 *
	 * @param  integer/string $projectId The project ID
	 * @return object $project simplexmlObject
	 * @access public
	 */
	public function getProjectContributors($projectId)
	{
		$url = 'http://www.ohloh.net/projects/'.$projectId.'/contributors.xml?api_key='.$this->apiKey.'&v='.$this->version;
		return $this->_process($url);
	}
